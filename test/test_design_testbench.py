import numpy as np
from doe.design import constraints_as_scipy_constraints, get_formula_from_string, n_ignore_eigvals
from doe.design_testbench import find_local_max_ipopt, optimal_design, logD, get_objective
import opti
import pandas as pd
...
def test_find_local_max_ipopt_nchoosek():
    ...
    N = (
        ...
        - n_ignore_eigvals(problem=problem, model_type="linear")
        + 3
    )
